...
class _TeacherScheduleScreenState extends State<TeacherScheduleScreen> {
  ...
  List<TeacherSchedule> _filterSchedules(List<TeacherSchedule> schedules) {
    ...
    final dateFiltered = schedules.where((s) => isSameDay(s.startTime, _selectedDay)).toList();

    
    if (_searchQuery.isEmpty) return dateFiltered;

    return dateFiltered.where((s) {
          ...
          child: _showSearch
              ? Container(
                  ...
                  decoration: BoxDecoration(
                    color: isDark ? AppColors.gray900 : AppColors.backgroundAlt,
                    border: Border(
                      bottom: BorderSide(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(
                          fontSize:
                              isDesktop ? AppSizes.textBase : AppSizes.textSm),
                      prefixIcon:
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(state.message,
                            style: TextStyle(
                                fontSize:
                                    isDesktop ? AppSizes.textXl : AppSizes.textLg),
                            textAlign: TextAlign.center),
                        SizedBox(height: isDesktop ? AppSizes.p24 : AppSizes.p16),
                        ElevatedButton.icon(
                          onPressed: () => context
                              .read<TeacherBloc>()
                              .add(LoadWeekSchedule(_selectedDay)),
                          ...
                          style: ElevatedButton.styleFrom(
                            padding: EdgeInsets.symmetric(
                              ...
                              horizontal: isDesktop ? AppSizes.p32 : AppSizes.p24,
                            ),
                          ),
                        ),
                      ],
                      ...
                      : ListView(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              padding: EdgeInsets.symmetric(
                                horizontal: isDesktop ? AppSizes.p16 : AppSizes.p12,
                                vertical: isDesktop ? AppSizes.p12 : AppSizes.p8,
                              ),
                              decoration: BoxDecoration(
                                color: isToday
                              ...
                              child: Row(
                                children: [
                                  ...
                                  if (isToday)
                                    Container(
                                      padding: EdgeInsets.symmetric(
                                          horizontal: AppSizes.p8, vertical: 2.h),
                                      decoration: BoxDecoration(
                                        color: AppColors.primary,
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color:
                                          isDark ? AppColors.gray900 : Colors.white,
                                      borderRadius: BorderRadius.circular(
                                          AppSizes.radiusMedium),
                                    ),
                                    child: Text(
