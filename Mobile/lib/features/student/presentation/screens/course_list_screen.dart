...
class _CourseListScreenState extends State<CourseListScreen> {
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                            color: isDark ? const Color(0xFF374151) : const Color(0xFFDBDFE6),
                          ),
                        ),
  ...
  void _showFilterBottomSheet(BuildContext context, bool isDark, bool isDesktop) {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFilterOption(context, isDark, isDesktop, 'Giao tiếp', 'Communication'),
            SizedBox(height: 16.h),
          ],
        ),
      ),
  ...
  Widget _buildFilterOption(BuildContext context, bool isDark, bool isDesktop, String label, String category) {
    return ListTile(
      title: Text(
        label,
        style: TextStyle(
